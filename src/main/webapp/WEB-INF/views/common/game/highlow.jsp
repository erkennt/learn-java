						...
						<div>
							<c:choose>
								<c:when test="${DrawState == 0}">
									<form:form action="/CardGame2/common/game/highlow/draw"
										...
										<input type="hidden" id="select" name="select" value="big">
											<button type="submit" class="btn btn-primary">大きい方に賭けてカードを引く</button>
									</form:form>
									<br>
									<form:form action="/CardGame2/common/game/highlow/draw"
										method="POST" modelAttribute="Game">
										...
										<input type="hidden" id="select" name="select" value="small">
											<button type="submit" class="btn btn-primary">小さい方に賭けてカードを引く</button>
									</form:form>
								</c:when>
