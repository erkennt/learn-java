				...
				<tr>
					<th style="text-align: center">
						<form class="form-inline"
							...
							<br> <label>ユーザー・ゲーム情報・ゲームログが削除されます</label><br> <input
								type="hidden" name="excel" /> <input type="hidden"
				...
				<tr>
					<th style="text-align: center">
						<form class="form-inline"
							...
							<button type="submit" class="btn btn-primary">実行</button>
							<br> <label>管理ユーザー・ゲーム設定が削除されます</label><br> <label>ユーザーが存在しない場合に実行できます</label>
